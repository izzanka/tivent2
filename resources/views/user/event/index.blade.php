            ...
            <div class="card">
              ...
              @endphp
                ...
                <div class="card-body">
                  ...
                  <form id="destroyEvent-form{{ $event->name }}" action="{{ route('events.destroy', $event) }}" method="POST">
                    @csrf
                    @method('DELETE')
                  </form>
                  <p class="card-text">
                      ...
                      document.getElementById('destroyEvent-form{{ $event->name }}').submit();" class="btn btn-danger float-right">Delete</a>
